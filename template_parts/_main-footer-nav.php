...
$footer_menu_id = $menu_class->get_menu_id('diadem-footer-menu');
$footer_menu = wp_get_nav_menu_items( $footer_menu_id );
$the_post_id = $post ? $post->ID : 0;
?>

<nav class="diadem-footer-navigation">

    <div class="diadem-footer-navigation diadem-footer-menu" id="footer-menu">
        <?php
